...
var core_GameObject = function() { };
$hxClasses["core.GameObject"] = core_GameObject;
core_GameObject.__name__ = true;
core_GameObject.prototype = {
	...
	,__class__: core_GameObject
};
var core_SpriteObject = function(position,size,rotation,sprite) {
	this.isVisible = true;
	...
	this.originPoint = new kha_math_Vector2(size.x * 0.5,size.y * 0.5);
	this.animationPlayer = new core_AnimationPlayer();
};
$hxClasses["core.SpriteObject"] = core_SpriteObject;
core_SpriteObject.__name__ = true;
core_SpriteObject.__super__ = core_GameObject;
core_SpriteObject.prototype = $extend(core_GameObject.prototype,{
	position: null
	,rotation: null
	,radius: null
	,size: null
	...
	,render: function(graphics) {
		graphics.pushRotation(core_Utils.degToRad(this.rotation),this.size.x * 0.5 + this.position.x,this.size.y * 0.5 + this.position.y);
		if(this.isVisible) {
			graphics.drawSubImage(this.sprite,this.position.x,this.position.y,this.animationPlayer.getCurrentFrame().x,this.animationPlayer.getCurrentFrame().y,this.size.x,this.size.y);
		}
		graphics.popTransformation();
	}
	,__class__: core_SpriteObject
});
var Background = function() {
	core_SpriteObject.call(this,new kha_math_Vector2(0,0),new kha_math_Vector2(288,512),0,kha_Assets.images.background_day);
};
$hxClasses["Background"] = Background;
Background.__name__ = true;
Background.__super__ = core_SpriteObject;
Background.prototype = $extend(core_SpriteObject.prototype,{
	__class__: Background
});
var Bird = function(position,onGameOverHandler) {
	this.currentGameState = GameState.Intro;
	this.isDead = false;
	this.velocity = 0;
	this.jumpForce = 5.5;
	this.deathFallSpeed = 750;
	this.gravity = -14.5;
	core_SpriteObject.call(this,position,new kha_math_Vector2(34,24),0,kha_Assets.images.bird);
	this.onGameOverHandler = onGameOverHandler;
	this.animationPlayer.addAnimation("flap",[new kha_math_Vector2i(0,0),new kha_math_Vector2i(34,0),new kha_math_Vector2i(68,0)],4);
	this.animationPlayer.addAnimation("glide",[new kha_math_Vector2i(34,0)],4);
	this.animationPlayer.play("flap");
};
$hxClasses["Bird"] = Bird;
Bird.__name__ = true;
Bird.__super__ = core_SpriteObject;
Bird.prototype = $extend(core_SpriteObject.prototype,{
	gravity: null
	,deathFallSpeed: null
	,jumpForce: null
	,velocity: null
	...
	,onGameOverHandler: null
	,update: function(delta) {
		core_SpriteObject.prototype.update.call(this,delta);
		switch(this.currentGameState._hx_index) {
		case 0:
			this.handleAnimations();
			break;
		case 1:
			if(!this.isDead) {
				this.handleFlight(delta);
			} else if(this.isDead && this.position.y < 380) {
				this.position.y += this.deathFallSpeed * delta;
			} else if(this.isDead && this.position.y >= 380) {
	...
	,kill: function() {
		core_SpriteObject.prototype.kill.call(this);
		this.isDead = true;
	}
	,setCurrentGameState: function(state) {
		this.currentGameState = state;
	}
	,handleFlight: function(delta) {
		this.velocity += this.gravity * delta;
		if(core_App.input.isMouseButtonJustPressed(0)) {
			this.velocity = this.jumpForce;
		}
		this.position.y -= this.velocity;
	}
	,handleAnimations: function() {
		if(this.velocity >= 0 && !this.isDead) {
			this.animationPlayer.play("flap");
		} else if(this.velocity < 0 && !this.isDead) {
			this.animationPlayer.play("glide");
		} else if(this.isDead) {
			this.animationPlayer.play("glide");
		}
	}
...
var Ground = function(position) {
	this.hasSpawnedNext = false;
	core_SpriteObject.call(this,position,new kha_math_Vector2(336,112),0,kha_Assets.images.base);
};
$hxClasses["Ground"] = Ground;
Ground.__name__ = true;
Ground.__super__ = core_SpriteObject;
Ground.prototype = $extend(core_SpriteObject.prototype,{
	hasSpawnedNext: null
	,update: function(delta) {
		core_SpriteObject.prototype.update.call(this,delta);
		this.position.x -= 125 * delta;
	}
	,__class__: Ground
});
...
Main.__name__ = true;
Main.main = function() {
	kha_System.start(new kha_SystemOptions("Flappy Bird",288,512,null,null),function(_) {
		kha_Assets.loadEverything(function() {
			kha_math_Random.init(new Date().getTime());
			core_App.input = new core_Input();
			core_App.uiManager = new core_UIManager();
			var project = new Project();
			var delta = 0;
			var currentTime = 0;
			kha_Scheduler.addTimeTask(function() {
				delta = kha_Scheduler.time() - currentTime;
				project.update(delta);
				core_App.uiManager.checkListeners();
				core_App.input.endFrame();
				currentTime = kha_Scheduler.time();
...
Math.__name__ = true;
var Pipe = function(position,rotation) {
	this.hasScoreCounted = false;
	core_SpriteObject.call(this,position,new kha_math_Vector2(52,320),rotation,kha_Assets.images.pipe_green);
};
$hxClasses["Pipe"] = Pipe;
Pipe.__name__ = true;
Pipe.__super__ = core_SpriteObject;
Pipe.prototype = $extend(core_SpriteObject.prototype,{
	hasScoreCounted: null
	,update: function(delta) {
		core_SpriteObject.prototype.update.call(this,delta);
		this.position.x -= 125 * delta;
	}
...
var GameState = $hxEnums["GameState"] = { __ename__:true,__constructs__:null
	,Intro: {_hx_name:"Intro",_hx_index:0,__enum__:"GameState",toString:$estr}
	,Gameplay: {_hx_name:"Gameplay",_hx_index:1,__enum__:"GameState",toString:$estr}
	,Dead: {_hx_name:"Dead",_hx_index:2,__enum__:"GameState",toString:$estr}
	,GameOver: {_hx_name:"GameOver",_hx_index:3,__enum__:"GameState",toString:$estr}
};
GameState.__constructs__ = [GameState.Intro,GameState.Gameplay,GameState.Dead,GameState.GameOver];
var Project = function() {
	this.isRestarting = false;
	this.score = 0;
	this.currentPipeSpawnTime = 0;
	this.pipeSpawnTime = 2;
	this.currentGameState = GameState.Intro;
	this.bird = new Bird(new kha_math_Vector2(100,256),$bind(this,this.onGameOver));
	this.background = new Background();
	this.groundPieces = [new Ground(new kha_math_Vector2(0,400))];
	this.pipes = [];
	this.scoreText = new core_UIText(new kha_math_Vector2(130,20),new kha_math_Vector2(0,0),0,"0",48,kha_Assets.fonts.flappy_font);
	this.restartButton = new RestartButton($bind(this,this.onRestartButtonClicked));
...
Project.prototype = {
	...
	,update: function(delta) {
		...
		case 0:
			if(core_App.input.isMouseButtonJustPressed(0)) {
				...
				this.bird.setCurrentGameState(this.currentGameState);
			}
			break;
		case 1:
			this.handleGroundPieces(delta);
			this.handlePipes(delta);
			this.handleCollisions();
			break;
		case 2:
			this.currentGameState = GameState.Dead;
			break;
		case 3:
			if(this.isRestarting) {
				...
				this.currentGameState = GameState.Intro;
				this.score = 0;
				this.scoreText.setText(Std.string(this.score));
				this.isRestarting = false;
				this.restartButton.isVisible = false;
			}
			break;
	...
	,render: function(framebuffer) {
		...
		graphics.begin(true,kha_Color.fromBytes(25,25,25));
		this.background.render(graphics);
		var _g = 0;
		var _g1 = this.pipes.length;
		while(_g < _g1) {
			var i = _g++;
			this.pipes[i].render(graphics);
		}
		var _g = 0;
		var _g1 = this.groundPieces.length;
		while(_g < _g1) {
			var i = _g++;
			this.groundPieces[i].render(graphics);
		}
		this.bird.render(graphics);
		this.restartButton.render(graphics);
		this.scoreText.render(graphics);
		graphics.end();
	}
	,handleGroundPieces: function(delta) {
		var i = this.groundPieces.length - 1;
		while(i >= 0) {
			this.groundPieces[i].update(delta);
			if(i == 0 && this.groundPieces[i].position.x <= -48 && !this.groundPieces[i].hasSpawnedNext) {
				this.groundPieces.push(new Ground(new kha_math_Vector2(286,400)));
				this.groundPieces[i].hasSpawnedNext = true;
			} else if(i == 0 && this.groundPieces[i].position.x <= -336) {
				HxOverrides.remove(this.groundPieces,this.groundPieces[i]);
			}
			--i;
		}
	}
	,handlePipes: function(delta) {
		if(this.currentPipeSpawnTime <= this.pipeSpawnTime) {
			this.currentPipeSpawnTime += delta;
		} else {
			var MIN_Y_POS = -275;
			var MAX_Y_POS = -100;
			var GAP = 100;
			var PIPE_LENGTH = 320;
			var pipeYPos = kha_math_Random.getIn(MIN_Y_POS,MAX_Y_POS);
			this.pipes.push(new Pipe(new kha_math_Vector2(288,pipeYPos),180));
			this.pipes.push(new Pipe(new kha_math_Vector2(288,pipeYPos + PIPE_LENGTH + GAP),0));
			this.currentPipeSpawnTime = 0;
		}
		var i = this.pipes.length - 1;
		while(i >= 0) {
			this.pipes[i].update(delta);
			if(this.pipes[i].position.x <= -52) {
				HxOverrides.remove(this.pipes,this.pipes[i]);
			}
			if(i % 2 == 0 && this.pipes[i].position.x + this.pipes[i].size.x < this.bird.position.x && !this.pipes[i].hasScoreCounted) {
				this.pipes[i].hasScoreCounted = true;
				this.score++;
				this.scoreText.setText(Std.string(this.score));
			}
			--i;
	...
	,handleCollisions: function() {
		...
		while(_g < _g1.length) {
			var pipe = _g1[_g];
			++_g;
			if(core_Collisons.circleRectangle(this.bird.radius,this.bird.position.x + this.bird.originPoint.x,this.bird.position.y + this.bird.originPoint.y,pipe.position.x,pipe.position.y,pipe.size.x,pipe.size.y)) {
				hasCollided = true;
			}
		}
		var _g = 0;
		var _g1 = this.groundPieces;
		while(_g < _g1.length) {
			var ground = _g1[_g];
			++_g;
			if(core_Collisons.circleRectangle(this.bird.radius,this.bird.position.x + this.bird.originPoint.x,this.bird.position.y + this.bird.originPoint.y,ground.position.x,ground.position.y,ground.size.x,ground.size.y)) {
				hasCollided = true;
			}
		}
		if(this.bird.position.y < -32) {
			hasCollided = true;
		}
		if(hasCollided) {
			this.bird.kill();
...
var core_UIObject = function(position,size,rotation) {
	this.isVisible = true;
	this.position = position;
	this.size = size;
	this.rotation = rotation;
	this.originPoint = new kha_math_Vector2(size.x * 0.5,size.y * 0.5);
	core_App.uiManager.addUIObject(this,$bind(this,this.onMouseEnter),$bind(this,this.onMouseExit),$bind(this,this.onMouseClick));
};
$hxClasses["core.UIObject"] = core_UIObject;
core_UIObject.__name__ = true;
core_UIObject.__super__ = core_GameObject;
core_UIObject.prototype = $extend(core_GameObject.prototype,{
	position: null
	,rotation: null
	,size: null
	,originPoint: null
	...
	,onMouseClick: function(mousePosition) {
	}
	,__class__: core_UIObject
});
var core_UIImage = function(position,size,rotation,sprite) {
	core_UIObject.call(this,position,size,rotation);
	this.sprite = sprite;
};
$hxClasses["core.UIImage"] = core_UIImage;
core_UIImage.__name__ = true;
core_UIImage.__super__ = core_UIObject;
core_UIImage.prototype = $extend(core_UIObject.prototype,{
	sprite: null
	,render: function(graphics) {
		core_UIObject.prototype.render.call(this,graphics);
		graphics.pushRotation(core_Utils.degToRad(this.rotation),this.size.x * 0.5 + this.position.x,this.size.y * 0.5 + this.position.y);
		if(this.isVisible) {
	...
	,__class__: core_UIImage
});
var RestartButton = function(clickHandler) {
	core_UIImage.call(this,new kha_math_Vector2(100,250),new kha_math_Vector2(130,46),0,kha_Assets.images.restart);
	this.clickHandler = clickHandler;
};
$hxClasses["RestartButton"] = RestartButton;
RestartButton.__name__ = true;
RestartButton.__super__ = core_UIImage;
RestartButton.prototype = $extend(core_UIImage.prototype,{
	clickHandler: null
	,onMouseClick: function(mousePosition) {
		this.clickHandler();
	}
	,__class__: RestartButton
});
var Std = function() { };
$hxClasses["Std"] = Std;
Std.__name__ = true;
...
var core_Animation = function(name,frames,fps,isLooped) {
	if(isLooped == null) {
		isLooped = true;
	}
	this.name = name;
...
var core_AnimationPlayer = function() {
	this.animations = new haxe_ds_StringMap();
	this.currentAnimation = "";
};
$hxClasses["core.AnimationPlayer"] = core_AnimationPlayer;
core_AnimationPlayer.__name__ = true;
core_AnimationPlayer.prototype = {
	animations: null
	,currentAnimation: null
	,isPaused: null
	,addAnimation: function(name,frames,fps) {
		var animation = new core_Animation(name,frames,fps);
		this.animations.h[name] = animation;
	}
	,play: function(name) {
	...
	,update: function(delta) {
		if(!this.isPaused && this.currentAnimation != "") {
			this.animations.h[this.currentAnimation].currentFrameLength += delta;
			if(this.animations.h[this.currentAnimation].currentFrameLength >= this.animations.h[this.currentAnimation].frameLength) {
				var fh = this.animations.h[this.currentAnimation];
				fh.currentFrame++;
				this.animations.h[this.currentAnimation].currentFrameLength = 0;
			}
			if(this.animations.h[this.currentAnimation].currentFrame >= this.animations.h[this.currentAnimation].numberOfFrames) {
				this.animations.h[this.currentAnimation].currentFrame = 0;
			}
		}
	}
	,pause: function() {
	...
	,getCurrentFrame: function() {
		if(this.currentAnimation != "") {
			return this.animations.h[this.currentAnimation].frames[this.animations.h[this.currentAnimation].currentFrame];
		}
		return new kha_math_Vector2i(0,0);
	}
	,__class__: core_AnimationPlayer
};
var core_App = function() { };
$hxClasses["core.App"] = core_App;
core_App.__name__ = true;
var core_Collisons = function() { };
$hxClasses["core.Collisons"] = core_Collisons;
core_Collisons.__name__ = true;
core_Collisons.circleRectangle = function(radius,cirX,cirY,rectX,rectY,rectW,rectH) {
	var testX = cirX;
	var testY = cirY;
	if(cirX < rectX) {
		testX = rectX;
...
var core_ButtonState = $hxEnums["core.ButtonState"] = { __ename__:true,__constructs__:null
	,Pressed: {_hx_name:"Pressed",_hx_index:0,__enum__:"core.ButtonState",toString:$estr}
	,Down: {_hx_name:"Down",_hx_index:1,__enum__:"core.ButtonState",toString:$estr}
	,Released: {_hx_name:"Released",_hx_index:2,__enum__:"core.ButtonState",toString:$estr}
	,NotPressed: {_hx_name:"NotPressed",_hx_index:3,__enum__:"core.ButtonState",toString:$estr}
};
core_ButtonState.__constructs__ = [core_ButtonState.Pressed,core_ButtonState.Down,core_ButtonState.Released,core_ButtonState.NotPressed];
var core_MouseState = function() {
};
$hxClasses["core.MouseState"] = core_MouseState;
core_MouseState.__name__ = true;
core_MouseState.prototype = {
	buttonStates: null
	,position: null
	,__class__: core_MouseState
};
var core_Input = function() {
	this.mouseState = new core_MouseState();
	this.keyStates = new haxe_ds_IntMap();
	kha_input_Keyboard.get().notify($bind(this,this.onKeyDown),$bind(this,this.onKeyUp));
	kha_input_Mouse.get().notify($bind(this,this.onMouseDown),$bind(this,this.onMouseUp),$bind(this,this.onMouseMove));
	this.mouseState.buttonStates = [];
	this.mouseState.buttonStates = [core_ButtonState.NotPressed,core_ButtonState.NotPressed,core_ButtonState.NotPressed];
	this.mouseState.position = new kha_math_Vector2i(0,0);
};
$hxClasses["core.Input"] = core_Input;
core_Input.__name__ = true;
core_Input.prototype = {
	keyStates: null
	,mouseState: null
	,endFrame: function() {
		var key = this.keyStates.keys();
		while(key.hasNext()) {
			var key1 = key.next();
			if(this.keyStates.h[key1] == core_ButtonState.Pressed) {
				var v = core_ButtonState.Down;
				this.keyStates.h[key1] = v;
			} else if(this.keyStates.h[key1] == core_ButtonState.Released) {
				var v1 = core_ButtonState.NotPressed;
				this.keyStates.h[key1] = v1;
			}
		}
		var _g = 0;
		var _g1 = this.mouseState.buttonStates.length;
		while(_g < _g1) {
			var i = _g++;
			if(this.mouseState.buttonStates[i] == core_ButtonState.Pressed) {
				this.mouseState.buttonStates[i] = core_ButtonState.Down;
			} else if(this.mouseState.buttonStates[i] == core_ButtonState.Released) {
				this.mouseState.buttonStates[i] = core_ButtonState.NotPressed;
			}
		}
	}
	,isKeyDown: function(keycode) {
		if(this.keyStates.h.hasOwnProperty(keycode) && this.keyStates.h[keycode] == core_ButtonState.Down) {
			return true;
		}
		return false;
	}
	,isKeyJustPressed: function(keycode) {
		if(this.keyStates.h.hasOwnProperty(keycode) && this.keyStates.h[keycode] == core_ButtonState.Pressed) {
			return true;
		}
		return false;
	}
	,isKeyReleased: function(keycode) {
		if(this.keyStates.h.hasOwnProperty(keycode) && this.keyStates.h[keycode] == core_ButtonState.Released) {
			return true;
		}
		return false;
	}
	...
	,isMouseButtonDown: function(button) {
		if(this.mouseState.buttonStates[button] == core_ButtonState.Down) {
			return true;
		}
		return false;
	}
	,isMouseButtonJustPressed: function(button) {
		if(this.mouseState.buttonStates[button] == core_ButtonState.Pressed) {
			return true;
		}
		return false;
	}
	,isMouseButtonReleased: function(button) {
		if(this.mouseState.buttonStates[button] == core_ButtonState.Released) {
			return true;
		}
		return false;
	}
	,onKeyDown: function(keycode) {
		if(this.keyStates.h.hasOwnProperty(keycode)) {
			var v = core_ButtonState.Pressed;
			this.keyStates.h[keycode] = v;
		} else {
			this.keyStates.h[keycode] = core_ButtonState.Pressed;
		}
	}
	,onKeyUp: function(keycode) {
		var v = core_ButtonState.Released;
		this.keyStates.h[keycode] = v;
	}
	,onMouseDown: function(button,x,y) {
		this.mouseState.buttonStates[button] = core_ButtonState.Pressed;
		this.mouseState.position = new kha_math_Vector2i(x,y);
	}
	,onMouseUp: function(button,x,y) {
		this.mouseState.buttonStates[button] = core_ButtonState.Released;
		this.mouseState.position = new kha_math_Vector2i(x,y);
	}
	,onMouseMove: function(oldX,oldY,newX,newY) {
		this.mouseState.position = new kha_math_Vector2i(oldX,oldY);
	}
	,__class__: core_Input
};
var core_UIManager = function() {
	this.uiObjects = [];
};
$hxClasses["core.UIManager"] = core_UIManager;
core_UIManager.__name__ = true;
core_UIManager.prototype = {
	uiObjects: null
	,checkListeners: function() {
		var mousePos = core_App.input.getMousePosition();
		var _g = 0;
		var _g1 = this.uiObjects;
		while(_g < _g1.length) {
			var uiObject = _g1[_g];
			++_g;
			if(mousePos.x >= uiObject.object.position.x && mousePos.x <= uiObject.object.position.x + uiObject.object.size.x && mousePos.y >= uiObject.object.position.y && mousePos.y <= uiObject.object.position.y + uiObject.object.size.y && !uiObject.hasMouseEntered) {
				uiObject.mouseEnter();
				uiObject.hasMouseEntered = true;
			} else if((mousePos.x < uiObject.object.position.x || mousePos.x > uiObject.object.position.x + uiObject.object.size.x || mousePos.y < uiObject.object.position.y || mousePos.y > uiObject.object.position.y + uiObject.object.size.y) && uiObject.hasMouseEntered) {
				uiObject.mouseExit();
				uiObject.hasMouseEntered = false;
			} else if(core_App.input.isMouseButtonJustPressed(0) && uiObject.hasMouseEntered) {
				uiObject.mouseClick(mousePos);
			}
		}
	}
	,addUIObject: function(object,mouseEnter,mouseExit,mouseClick) {
		this.uiObjects.push({ object : object, hasMouseEntered : false, mouseEnter : mouseEnter, mouseExit : mouseExit, mouseClick : mouseClick});
	}
	,__class__: core_UIManager
};
var core_UIText = function(position,size,rotation,text,textSize,font) {
	core_UIObject.call(this,position,size,rotation);
	this.text = text;
	this.textSize = textSize;
	this.font = font;
};
$hxClasses["core.UIText"] = core_UIText;
core_UIText.__name__ = true;
core_UIText.__super__ = core_UIObject;
core_UIText.prototype = $extend(core_UIObject.prototype,{
	text: null
	,textSize: null
	,font: null
	,render: function(graphics) {
		...
		graphics.set_fontSize(this.textSize);
		if(this.isVisible) {
	...
	,__class__: core_UIText
});
var core_Utils = function() { };
$hxClasses["core.Utils"] = core_Utils;
core_Utils.__name__ = true;
core_Utils.radToDeg = function(radians) {
	return radians * 180 / Math.PI;
};
core_Utils.degToRad = function(degree) {
...
var kha__$Assets_ImageList = function() {
	this.names = ["background_day","base","bird","pipe_green","restart"];
	this.restartSize = 399;
	this.restartDescription = { name : "restart", original_height : 46, file_sizes : [399], original_width : 130, files : ["restart.png"], type : "image"};
	this.restartName = "restart";
	this.restart = null;
	this.pipe_greenSize = 2489;
	this.pipe_greenDescription = { name : "pipe_green", original_height : 320, file_sizes : [2489], original_width : 52, files : ["pipe-green.png"], type : "image"};
	this.pipe_greenName = "pipe_green";
	this.pipe_green = null;
	this.birdSize = 513;
	this.birdDescription = { name : "bird", original_height : 24, file_sizes : [513], original_width : 102, files : ["bird.png"], type : "image"};
	this.birdName = "bird";
	this.bird = null;
	this.baseSize = 595;
	this.baseDescription = { name : "base", original_height : 112, file_sizes : [595], original_width : 336, files : ["base.png"], type : "image"};
	this.baseName = "base";
	this.base = null;
	this.background_daySize = 6902;
	this.background_dayDescription = { name : "background_day", original_height : 512, file_sizes : [6902], original_width : 288, files : ["background-day.png"], type : "image"};
	this.background_dayName = "background_day";
	this.background_day = null;
};
...
kha__$Assets_ImageList.prototype = {
	...
	,background_day: null
	,background_dayName: null
	,background_dayDescription: null
	,background_daySize: null
	,background_dayLoad: function(done,failure) {
		kha_Assets.loadImage("background_day",function(image) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 142, className : "kha._Assets.ImageList", methodName : "background_dayLoad"});
	}
	,background_dayUnload: function() {
		this.background_day.unload();
		this.background_day = null;
	}
	,base: null
	,baseName: null
	...
	,baseSize: null
	,baseLoad: function(done,failure) {
		kha_Assets.loadImage("base",function(image) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 142, className : "kha._Assets.ImageList", methodName : "baseLoad"});
	}
	,baseUnload: function() {
		this.base.unload();
		this.base = null;
	...
	,birdSize: null
	,birdLoad: function(done,failure) {
		kha_Assets.loadImage("bird",function(image) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 142, className : "kha._Assets.ImageList", methodName : "birdLoad"});
	}
	,birdUnload: function() {
		this.bird.unload();
		this.bird = null;
	...
	,pipe_green: null
	,pipe_greenName: null
	,pipe_greenDescription: null
	,pipe_greenSize: null
	,pipe_greenLoad: function(done,failure) {
		kha_Assets.loadImage("pipe_green",function(image) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 142, className : "kha._Assets.ImageList", methodName : "pipe_greenLoad"});
	}
	,pipe_greenUnload: function() {
		this.pipe_green.unload();
		this.pipe_green = null;
	}
	,restart: null
	,restartName: null
	,restartDescription: null
	,restartSize: null
	,restartLoad: function(done,failure) {
		kha_Assets.loadImage("restart",function(image) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 142, className : "kha._Assets.ImageList", methodName : "restartLoad"});
	}
	,restartUnload: function() {
		this.restart.unload();
		this.restart = null;
	}
	,names: null
...
var kha__$Assets_FontList = function() {
	this.names = ["flappy_font"];
	this.flappy_fontSize = 6632;
	this.flappy_fontDescription = { name : "flappy_font", file_sizes : [6632], files : ["flappy-font.ttf"], type : "font"};
	this.flappy_fontName = "flappy_font";
	this.flappy_font = null;
};
...
kha__$Assets_FontList.prototype = {
	...
	,flappy_font: null
	,flappy_fontName: null
	,flappy_fontDescription: null
	,flappy_fontSize: null
	,flappy_fontLoad: function(done,failure) {
		kha_Assets.loadFont("flappy_font",function(font) {
			done();
		},failure,{ fileName : "kha/internal/AssetsBuilder.hx", lineNumber : 154, className : "kha._Assets.FontList", methodName : "flappy_fontLoad"});
	}
	,flappy_fontUnload: function() {
		this.flappy_font.unload();
		this.flappy_font = null;
	}
	,names: null
...
kha_js_graphics4_Graphics.prototype = {
	...
	,end: function() {
		...
		case 0:
			break;
		case 1280:
			haxe_Log.trace("WebGL error: Invalid enum",{ fileName : "kha/js/graphics4/Graphics.hx", lineNumber : 169, className : "kha.js.graphics4.Graphics", methodName : "end"});
			break;
		case 1281:
			haxe_Log.trace("WebGL error: Invalid value",{ fileName : "kha/js/graphics4/Graphics.hx", lineNumber : 171, className : "kha.js.graphics4.Graphics", methodName : "end"});
			break;
		case 1282:
			haxe_Log.trace("WebGL error: Invalid operation",{ fileName : "kha/js/graphics4/Graphics.hx", lineNumber : 173, className : "kha.js.graphics4.Graphics", methodName : "end"});
			break;
		case 1285:
			haxe_Log.trace("WebGL error: Out of memory",{ fileName : "kha/js/graphics4/Graphics.hx", lineNumber : 177, className : "kha.js.graphics4.Graphics", methodName : "end"});
			break;
		case 1286:
			haxe_Log.trace("WebGL error: Invalid framebuffer operation",{ fileName : "kha/js/graphics4/Graphics.hx", lineNumber : 175, className : "kha.js.graphics4.Graphics", methodName : "end"});
			break;
		case 37442:
			haxe_Log.trace("WebGL error: Context lost",{ fileName : "kha/js/graphics4/Graphics.hx", lineNumber : 179, className : "kha.js.graphics4.Graphics", methodName : "end"});
			break;
		default:
			haxe_Log.trace("Unknown WebGL error",{ fileName : "kha/js/graphics4/Graphics.hx", lineNumber : 181, className : "kha.js.graphics4.Graphics", methodName : "end"});
		}
	}
	,flush: function() {
	}
